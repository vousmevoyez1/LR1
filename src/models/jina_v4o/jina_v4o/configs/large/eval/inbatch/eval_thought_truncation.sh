...
# --- 模型配置 ---
CKPT_NAME="MTtrunproO5"
CKPT_PATH="/data/LR1/checkpoint/jina_v4oauxpro/Large/Instruct/InBatch_rs5_tt5/jina_v4oaux_epoch_2.pth"
...
EXISTING_CAND_DIR="/data/LR1/runs/eval_finetuneda/MauxprT5/embed/JinaV4/Large/Instruct/InBatch/reason_steps_5/cand_pool"
