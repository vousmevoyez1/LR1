...
CHECKPOINTS=(
    "MnewlossT5:/data/LR1/checkpoint/jina_v4o/Large/Instruct/InBatch_rs5_tt5/jina_v4o_epoch_1.pth:5:5"
    ...
    # "MtestT7:/data/LR1/checkpointMTOA/jina_v4o/Large/Instruct/InBatch_rs7_tt7/jina_v4o_epoch_4.pth:7:7"
    # "MtestT9:/data/LR1/checkpointMTOA/jina_v4o/Large/Instruct/InBatch_rs9_tt9/jina_v4o_epoch_4.pth:9:9"
)
...
for CKPT_CONFIG in "${CHECKPOINTS[@]}"; do
    ...
    export MASTER_PORT=$((25600 + PORT_OFFSET))
