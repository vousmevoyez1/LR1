...
# --- 模型配置 ---
CKPT_NAME="${CKPT_NAME:-MTtrunO3}"
CKPT_PATH="${CKPT_PATH:-/data/LR1/checkpointMTO3/jina_v4o/Large/Instruct/InBatch/jina_v4o_epoch_2.pth}"
NUM_THOUGHT_TOKENS="${NUM_THOUGHT_TOKENS:-3}"   # 训练时使用的thought token数量
...
if [ ! -f "$COMMON_DIR/mbeir_embedder_per_step.py" ] || [ ! -f "$COMMON_DIR/mbeir_retriever.py" ]; then
...
EXISTING_CAND_DIR="${EXISTING_CAND_DIR:-/data/LR1/runs/eval_finetuned/MT5epo3/embed/JinaV4/Large/Instruct/InBatch/reason_steps_5/cand_pool}"
...
echo "  NUM_THOUGHT_TOKENS=$NUM_THOUGHT_TOKENS"
echo "  BASE_WORK_DIR=$BASE_WORK_DIR"
echo "  EXISTING_CAND_DIR=$EXISTING_CAND_DIR"
